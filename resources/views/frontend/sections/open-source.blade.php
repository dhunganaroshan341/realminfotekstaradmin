<section id="open-source" class="border-t border-neutral-200">
    ...
    <div class="px-6 mx-auto max-w-7xl py-28 lg:px-8 lg:py-36">
        ...
        <div class="mt-20 space-y-4">
            ...
            @foreach($openSource as $package)
                ...
                <article class="group rounded-[2rem] border border-neutral-200 p-8 transition duration-300 hover:border-neutral-400 sm:p-10 lg:p-12">
                    ...
                    <div class="grid gap-10 lg:grid-cols-12 lg:items-center">
                        ...
                        <div class="lg:col-span-7">
                            ...
                            <h3 class="mt-6 text-3xl font-semibold tracking-tight text-neutral-950 sm:text-4xl">
                            ...
                            <p class="max-w-2xl mt-5 text-base leading-7 text-neutral-600">
                        ...
                        <div class="lg:col-span-5 lg:flex lg:justify-end">
                            ...
                            <div class="w-full max-w-sm">
                                ...
                                <div class="flex items-center gap-6 pt-6 mt-8 border-t border-neutral-200">

                                    <a
                                        href="{{ $package['github_url'] }}"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        class="inline-flex items-center gap-2 text-sm font-medium group/link text-neutral-950"
                                    >
