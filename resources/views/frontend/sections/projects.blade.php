<section id="work" class="border-t border-neutral-200">
    ...
    <div class="px-6 mx-auto max-w-7xl py-28 lg:px-8 lg:py-36">
        ...
        <div class="mt-20 space-y-6">
            ...
            @foreach($projects as $project)
                ...
                @if($loop->first)
                    ...
                    {{-- Featured Project --}}
                    <article
                        class="group overflow-hidden rounded-[2rem] bg-neutral-100"
                    >

                        <div class="grid lg:grid-cols-2">

                            {{-- Project Preview --}}
                            <div class="relative min-h-[360px] overflow-hidden bg-neutral-200 lg:min-h-[520px]">
                            ...
                            <div class="flex flex-col justify-between p-8 sm:p-10 lg:p-14">
                                ...
                                <div>
                                    ...
                                    <h3 class="max-w-lg mt-16 text-4xl font-semibold tracking-tight text-neutral-950 sm:text-5xl">
                                ...
                                <div class="mt-16">
                                    ...
                                    <div class="pt-6 mt-10 border-t border-neutral-300">

                                        <a
                                            href="#"
                                            class="flex items-center justify-between text-sm font-medium group/link text-neutral-950"
                                        >
                                            ...
                                            <span class="flex items-center justify-center w-10 h-10 transition duration-300 border rounded-full border-neutral-300 group-hover/link:-translate-y-1 group-hover/link:translate-x-1 group-hover/link:border-neutral-950">
                                                ↗
                                            </span>
                ...
                @else
                    ...
                    {{-- Other Projects --}}
                    <article
                        class="group rounded-[2rem] border border-neutral-200 p-8 transition duration-300 hover:border-neutral-400 sm:p-10"
                    >
                        ...
                        <div class="grid gap-8 lg:grid-cols-12 lg:items-center">
                            ...
                            <div class="lg:col-span-6">
                                ...
                                <p class="max-w-xl mt-3 text-sm leading-7 text-neutral-600">
                            ...
                            <div class="lg:col-span-3 lg:flex lg:justify-end">
                                ...
                                >
                                    ...
                                    <span class="flex items-center justify-center w-10 h-10 transition duration-300 border rounded-full border-neutral-300 group-hover/link:translate-x-1 group-hover/link:border-neutral-950">
        ...
        {{-- Bottom --}}
        <div class="flex justify-between pt-8 mt-12 border-t border-neutral-200">
